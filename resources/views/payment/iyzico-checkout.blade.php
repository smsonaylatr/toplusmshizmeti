...
<head>
    ...
    <style>
        ...
        #iyzipay-checkout-form iframe { width: 100% !important; }
    </style>
</head>
...
<div class="min-h-screen flex flex-col">
    ...
    <header class="bg-[#2563eb] h-[46px] flex items-center px-4">
        ...
        <span class="text-white/80 text-xs">iyzico Güvenli Ödeme</span>
    ...
    <main class="flex-1 flex items-start justify-center p-4 pt-8">
        <div class="w-full max-w-2xl">
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-200 mb-4 overflow-hidden">
                <div class="bg-gradient-to-r from-[#f95f62] to-[#e74c8b] p-4">
                    <h1 class="text-white font-bold text-lg">Ödeme Sayfası</h1>
                    <p class="text-pink-100 text-sm mt-0.5">iyzico güvenli ödeme altyapısı</p>
                </div>
                <div class="p-4 flex items-center justify-between">
                    ...
                    <div class="text-right">
                        ...
                        <p class="font-bold text-2xl text-[#f95f62]">{{ number_format($order->total_amount, 2, ',', '.') }} ₺</p>
            ...
            <p class="text-center text-xs text-gray-400 mt-4">
                Kart bilgileriniz iyzico altyapısında şifrelenerek işlenir. TopluSMS kart bilgilerinizi saklamaz.
            </p>
        </div>
    </main>
</div>
