...
<div>
    ...
    <textarea
        {{ $attributes->merge([
            'class' => 'w-full px-4 py-2.5 bg-slate-800/50 border rounded-lg text-sm text-white placeholder-slate-500 transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-offset-0 resize-none ' .
