        ...
        <div class="xl:col-span-2 space-y-4">
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                ...
                <div class="p-6">
                    ...
                    {{-- QR Kod Taratma --}}
                    <div wire:poll.2s="checkConnection" class="text-center py-2">
                        <div class="w-56 h-56 mx-auto bg-white border-2 border-gray-100 rounded-2xl p-3 mb-4 relative">
                            <div class="w-full h-full bg-gradient-to-br from-gray-100 to-gray-50 rounded-xl flex items-center justify-center relative overflow-hidden">
                                @if($qrCode)
                                    <img wire:key="qrcode-img" src="{{ $qrCode }}" alt="QR Code" class="w-full h-full object-contain rounded-lg">
                                @else
                                    <div wire:key="qrcode-fallback" class="w-40 h-40 bg-gray-200 rounded-lg flex items-center justify-center text-gray-400 text-xs text-center p-4">
