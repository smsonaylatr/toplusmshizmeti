<div>
    <h1 class="text-2xl font-bold text-gray-800 mb-1">Toplu Numaralara WhatsApp</h1>
    <div class="mb-4"><h2 class="text-base font-semibold text-green-600 border-b-2 border-green-600 inline-block pb-1">Numaralara Mesaj Gönder</h2></div>
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
        ...
        <div class="p-4 bg-gradient-to-r from-green-500 to-green-600 text-white text-[12px] leading-relaxed flex items-start gap-3">
            ...
            <div>
                ...
                Birden fazla numaraya WhatsApp mesajı göndermek için numaraları aşağıdaki alana giriniz. Her satıra bir numara yazınız.
            </div>
        </div>
        ...
        <div class="p-5">
            <form wire:submit="send">
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    ...
                    <div class="space-y-4">
                        <div>
                            <label class="block text-xs text-gray-500 mb-1.5 font-medium">Telefon Numaraları</label>
                            <textarea wire:model="customNumbers" rows="10" placeholder="Her satıra bir numara yazın...&#10;5301234567&#10;5321234567&#10;5351234567" class="w-full px-3.5 py-2.5 border border-gray-200 rounded-xl text-sm resize-y bg-gray-50/50 focus:outline-none focus:ring-2 focus:ring-green-500/20 focus:border-green-500 transition-all font-mono"></textarea>
                            <p class="text-[11px] text-gray-400 mt-1">Her satıra bir numara veya virgülle ayırarak yazın</p>
                        </div>
                        @error('customNumbers') <p class="text-red-500 text-xs">{{ $message }}</p> @enderror
