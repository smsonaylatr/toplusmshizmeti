<div>
    <h1 class="text-2xl font-bold text-gray-800 mb-1">Tek Numaraya WhatsApp</h1>
    <div class="mb-4"><h2 class="text-base font-semibold text-green-600 border-b-2 border-green-600 inline-block pb-1">Tek Numaraya Mesaj Gönder</h2></div>
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
        ...
        <div class="p-4 bg-gradient-to-r from-green-500 to-green-600 text-white text-[12px] leading-relaxed flex items-start gap-3">
            ...
            <div>
                ...
                Tek bir numaraya WhatsApp mesajı gönderin. Mesajınız WhatsApp Business API üzerinden iletilecektir.
            </div>
        </div>
        ...
        <div class="p-5">
            <form wire:submit="send">
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    {{-- Sol: Numara ve ayarlar --}}
                    <div class="space-y-4">
                        {{-- Telefon Numarası --}}
                        <div class="relative">
                            <input wire:model="phone" type="text" placeholder="5XX XXX XX XX" class="w-full px-3.5 py-2.5 border border-gray-200 rounded-xl text-sm bg-gray-50/50 focus:outline-none focus:ring-2 focus:ring-green-500/20 focus:border-green-500 transition-all">
                            <label class="absolute -top-2 left-3 bg-white px-1.5 text-[10px] text-gray-400 font-medium">* Alıcı Telefon Numarası</label>
                        </div>
